...
local defaults = {
	...
	LazyButton = {
		bg = colors.one_bg,
		fg = lighten(colors.light_grey, vim.o.bg == "dark" and 10 or -20),
	},
...
defaults =
	require("base46").merge_tb(defaults, require("base46").get_hl_tb("statusline"))

local hexify_ColorStrs = require("base46").turn_str_to_color
local user_new_highlights = Base46.opts.hl_add

return require("base46").merge_tb(defaults, hexify_ColorStrs(user_new_highlights))
